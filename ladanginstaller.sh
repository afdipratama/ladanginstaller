...
echo -e $white"	             \/        \/                  \/      \/"
echo -e $red"          #####################################################"
echo -e $white"          # $white 		#sgbshare Tools Installer  $white           #"
echo -e $red"          # $white 		happy tuyul ~ afudikun        $white        #"
echo -e $white"          # $white 		contact : lectra5ix@gmail.com  $white       #"
echo -e $red"       	  #$white Greetz :405 - SGB TEAM - IndoCheck - DarkSide Est #"
